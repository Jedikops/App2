...
namespace App2.Code
{
    public class DisplayI2C
    {
        ...
        public DisplayI2C(ref I2cDevice dev, byte Rs, byte Rw, byte En, byte D4, byte D5, byte D6, byte D7, byte Bl)
        {
            _i2cPortExpander = dev;
            this._Rs = Rs;
            this._Rw = Rw;
            this._En = En;
            this._D4 = D4;
        ...
        public DisplayI2C(byte deviceAddress, string controllerName, byte Rs, byte Rw, byte En, byte D4, byte D5, byte D6, byte D7, byte Bl)
        {
            ...
            this.startI2C(deviceAddress, controllerName);
        }
